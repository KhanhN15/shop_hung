                        ...
                        <label htmlFor="4f8f433c271" className="_3AxLJ">
                          ...
                          <div className="_3KXUX">
                            <input
                              ...
                              aria-activedescendant="departure-airport-0"
                        ...
                        <label htmlFor="ca476a301a83" className="_3AxLJ">
                          ...
                          <div className="_3KXUX">
                            <input
                              ...
                              aria-label="Điểm đến"
                              aria-activedescendant="destination-airport-0"
                              aria-haspopup="listbox"
                              aria-expanded="false"
                              id="ca476a301a83"
                              className="K07a_"
                  ...
                  >
                    <div>
                      ...
                      <div className="p6vKa">
                        ...
                        <label htmlFor="9cd75a323864" className="_3AxLJ">
                          <i className="_1NPyI">
                            <svg
                              fill="#8F8F8F"
                              stroke="#8F8F8F"
                          ...
                          <div className="_3KXUX">
                            <input
                              ...
                              id="9cd75a323864"
                              className="K07a_"
                              defaultValue="1 Người lớn, 0 Trẻ em, 0 Em bé"
                            />
                          </div>
                        </label>
                        <div />
                        ...
                        <label htmlFor="8eb4c7cb858d" className="_3AxLJ">
                          ...
                          <div className="_3KXUX">
                            <input
                              readOnly
                              aria-label="Hạng ghế"
                              aria-describedby="corporateSeatClassInfo"
                              aria-haspopup="listbox"
                              aria-expanded="false"
                              aria-activedescendant="option-ECONOMY"
                              id="8eb4c7cb858d"
                              className="K07a_"
                              defaultValue="Phổ thông"
                            />
                          </div>
                          <i className="t7oOl">
                            <svg
                            ...
                            >
                              <g transform="translate(0.166667, 4.033325)">
                                <path
                                  color="#8F8F8F"
                                  d="M7.33333333,7.33333333 L0.488888889,0.488888889"
                                />
                                <path
                                  color="#8F8F8F"
                                  d="M7.33333333,7.33333333 L14.1777778,0.488888889"
                                />
                              </g>
                            </svg>
                          </i>
